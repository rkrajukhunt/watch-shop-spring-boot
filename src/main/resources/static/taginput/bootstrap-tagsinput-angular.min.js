...
angular.module("bootstrap-tagsinput", []).directive("bootstrapTagsinput", [ function() {
	function a(a, b) {
		if (b) return angular.isFunction(a.$parent[b]) ? a.$parent[b] : function(a) {
				return a[b]
		}
	}
	return {
		...
		link : function(b, c, d) {
			$(function() {
				...
				e.on("itemAdded", function(a) {
					b.model.indexOf(a.item) === -1 && b.model.push(a.item)
				}), e.on("itemRemoved", function(a) {
					var c = b.model.indexOf(a.item);
					c !== -1 && b.model.splice(c, 1)
				});
				var i = b.model.slice();
